    ...
    shared_examples_for 'markdown parser' do
      ...
      describe 'links' do
        ...
        it "should allow HTML syntax for hyperlinking" do
          markdown("Hello <a href='http://example.com'>An example</a>.").should =~ %r{<a href='http://example.com'>An example</a>}
        end
        ...
        it "should auto hyperlink URLs" do
          markdown("Hello http://example.com.").should =~ %r{<a href=\"http://example.com\">http://example.com</a>}
        end
